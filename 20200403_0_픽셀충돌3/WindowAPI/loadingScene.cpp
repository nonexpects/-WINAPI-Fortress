...
void loadingScene::loadingImage()
{
	...
	*/
	...
	_loading->loadImage("fortress_map", "fortress_map.bmp", 2400, 1100);
	_loading->loadImage("fortress_f", "fortress_f.bmp", 2400, 1100);
	_loading->loadFrameImage("ball", "Fortress2.bmp", 240, 120, 2, 1);
}
